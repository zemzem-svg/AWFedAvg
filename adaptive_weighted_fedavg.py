    ...
    def __init__(self):
        ...
        try:
            ...
            if self.gpu_available:
                print(f"✅ GPU monitoring enabled - {len(gpus)} GPU(s) detected")
        except ImportError:
...
class EnhancedFlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        try:
            ...
            # ⭐ ADD THIS: Clean up GPU memory after each training session
            cleanup_gpu_memory()
    ...
    def evaluate(self, parameters, config):
        ...
        try:
            ...
            # ⭐ ADD THIS: Clean up GPU memory after evaluation
            cleanup_gpu_memory()
...
if __name__ == "__main__":
    ...
    print("-" * 50)
    print("✅ Simplified client configurations with only activation levels")
    ...
    random.seed(45)
    print("\n🚀 AWFedAvg with Comprehensive Resource Tracking")  
    # Test environment creation to verify cleanup
    print("\n🧪 Testing Environment Creation (Verification):")
    try:
    ...
    try:
        ...
        print(f"❌ Error during cleaned AWFedAvg experiment: {e}")
        import traceback
        traceback.print_exc()
